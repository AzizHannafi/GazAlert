 ...
 * <td align="left" valign="top">An {@link com.example.gazalert.org.eclipse.paho.android.service.Status} value indicating success or
...
public class MqttService extends Service implements MqttTraceHandler {
   ...
   */
  void callbackToActivity(String clientHandle, com.example.gazalert.org.eclipse.paho.android.service.Status status,
      Bundle dataBundle) {
   ...
   * @return {@link com.example.gazalert.org.eclipse.paho.android.service.Status}
   */
  public com.example.gazalert.org.eclipse.paho.android.service.Status acknowledgeMessageArrival(String clientHandle, String id) {
    if (messageStore.discardArrived(clientHandle, id)) {
      return com.example.gazalert.org.eclipse.paho.android.service.Status.OK;
    }
    else {
      return com.example.gazalert.org.eclipse.paho.android.service.Status.ERROR;
    }
  }
  ...
  private void traceCallback(String severity, String tag, String message) {
    if ((traceCallbackId != null) && (traceEnabled)) {
      ...
      callbackToActivity(traceCallbackId, com.example.gazalert.org.eclipse.paho.android.service.Status.ERROR, dataBundle);
    }
  }
