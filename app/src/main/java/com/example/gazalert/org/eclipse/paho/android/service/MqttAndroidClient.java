...
import com.example.gazalert.org.eclipse.paho.android.service.MqttServiceBinder;
import com.example.gazalert.org.eclipse.paho.android.service.MqttServiceConstants;
import com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid;
import com.example.gazalert.org.eclipse.paho.android.service.MqttTraceHandler;
import com.example.gazalert.org.eclipse.paho.android.service.ParcelableMqttMessage;
import com.example.gazalert.org.eclipse.paho.android.service.Status;
...
public class MqttAndroidClient extends BroadcastReceiver implements
	...
	private static final String SERVICE_NAME = "com.example.gazalert.org.eclipse.paho.android.service.MqttService";
	...
	private com.example.gazalert.org.eclipse.paho.android.service.MqttService mqttService;
	...
	private com.example.gazalert.org.eclipse.paho.android.service.MqttTraceHandler traceCallback;
	...
	public IMqttToken connect(MqttConnectOptions options, Object userContext,
		...
		IMqttToken token = new com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid(this, userContext,
				callback);
	...
	public IMqttToken disconnect() throws MqttException {
		IMqttToken token = new com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid(this, null,
				null);
	...
	public IMqttDeliveryToken publish(String topic, byte[] payload, int qos,
		...
		com.example.gazalert.org.eclipse.paho.android.service.MqttDeliveryTokenAndroid token = new com.example.gazalert.org.eclipse.paho.android.service.MqttDeliveryTokenAndroid(
	...
	public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, IMqttActionListener callback, IMqttMessageListener[] messageListeners) throws MqttException {
		IMqttToken token = new com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid(this, userContext, callback, topicFilters);
		String activityToken = storeToken(token);
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (MqttServiceConstants.CONNECT_ACTION.equals(action)) {
			...
			mqttService.traceError(com.example.gazalert.org.eclipse.paho.android.service.MqttService.TAG, "Callback action doesn't exist.");
		}
	...
	public boolean acknowledgeMessage(String messageId) {
		if (messageAck == Ack.MANUAL_ACK) {
			com.example.gazalert.org.eclipse.paho.android.service.Status status = mqttService.acknowledgeMessageArrival(clientHandle, messageId);
			return status == com.example.gazalert.org.eclipse.paho.android.service.Status.OK;
		}
		return false;
	...
	private void disconnected(Bundle data) {
		...
		if (token != null) {
			((com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid) token).notifyComplete();
		}
		if (callback != null) {
	...
	private void simpleAction(IMqttToken token, Bundle data) {
		if (token != null) {
			com.example.gazalert.org.eclipse.paho.android.service.Status status = (com.example.gazalert.org.eclipse.paho.android.service.Status) data
					.getSerializable(MqttServiceConstants.CALLBACK_STATUS);
			if (status == com.example.gazalert.org.eclipse.paho.android.service.Status.OK) {
				((com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid) token).notifyComplete();
			}
			else {
				Exception exceptionThrown = (Exception) data.getSerializable(MqttServiceConstants.CALLBACK_EXCEPTION);
				((com.example.gazalert.org.eclipse.paho.android.service.MqttTokenAndroid) token).notifyFailure(exceptionThrown);
			}
		} else {
	...
	private void messageDeliveredAction(Bundle data) {
		...
		if (token != null) {
			if (callback != null) {
				com.example.gazalert.org.eclipse.paho.android.service.Status status = (com.example.gazalert.org.eclipse.paho.android.service.Status) data
						.getSerializable(MqttServiceConstants.CALLBACK_STATUS);
				if (status == com.example.gazalert.org.eclipse.paho.android.service.Status.OK && token instanceof IMqttDeliveryToken) {
