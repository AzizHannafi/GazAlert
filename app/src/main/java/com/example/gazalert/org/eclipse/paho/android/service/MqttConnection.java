...
import com.example.gazalert.org.eclipse.paho.android.service.AlarmPingSender;
import com.example.gazalert.org.eclipse.paho.android.service.MessageStore.StoredMessage;
...
class MqttConnection implements MqttCallbackExtended {
	...
	private com.example.gazalert.org.eclipse.paho.android.service.MqttService service = null;
			...
			if (persistence == null) {
				...
				if (myDir == null) {
					...
					if(myDir == null){
						...
						service.callbackToActivity(clientHandle, com.example.gazalert.org.eclipse.paho.android.service.Status.ERROR,
								resultBundle);
						return;
					}
				}
	...
	private void doAfterConnectSuccess(final Bundle resultBundle) {
		...
		acquireWakeLock();
		service.callbackToActivity(clientHandle, com.example.gazalert.org.eclipse.paho.android.service.Status.OK, resultBundle);
		deliverBacklog();
		setConnectingState(false);
		disconnected = false;
		releaseWakeLock();
	...
	private void doAfterConnectFail(final Bundle resultBundle){
		...
		disconnected = true;
		setConnectingState(false);
		service.callbackToActivity(clientHandle, com.example.gazalert.org.eclipse.paho.android.service.Status.ERROR, resultBundle);
		releaseWakeLock();
	}
	...
	public void deliveryComplete(IMqttDeliveryToken messageToken) {
		...
		if (message != null) { // If I don't know about the message, it's
			...
			if (activityToken != null) {
				...
				service.callbackToActivity(clientHandle, com.example.gazalert.org.eclipse.paho.android.service.Status.OK,
						resultBundle);
			}
			resultBundle.putString(MqttServiceConstants.CALLBACK_ACTION,
